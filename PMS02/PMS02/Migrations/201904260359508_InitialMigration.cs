                ...
                c => new
                    {
                        ...
                        Photo = c.String(nullable: false, maxLength: 200, fixedLength: true),
                        ...
                        Type = c.String(nullable: false, maxLength: 200, fixedLength: true),
                        IsEmailVerified = c.String(nullable: false, maxLength: 200, fixedLength: true),
                    })
                ...
                c => new
                    {
                        ...
                        Reciever_ID = c.Int(),
                        Project_ID = c.Int(),
                        respone = c.String(maxLength: 200, fixedLength: true),
                    })
                .PrimaryKey(t => t.ID)
